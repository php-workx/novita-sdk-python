...
def main() -> None:
    ...
    with NovitaClient() as client:
        ...
        updated = client.gpu.update_instance(instance_id, update)
        ...
        print("=" * 60)
        stop_response = client.gpu.stop_instance(instance_id)
        ...
        print("=" * 60)
        start_response = client.gpu.start_instance(instance_id)
        ...
        print("=" * 60)
        delete_response = client.gpu.delete_instance(instance_id)
