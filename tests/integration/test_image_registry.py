...
class TestImageRegistry:
    ...
    def test_list_repository_auths(self, client):
        """Test listing all container registry authentications."""
        response = client.gpu.image_registry.list_auths()

        assert response is not None
        assert hasattr(response, "data")
        assert isinstance(response.data, list)

    def test_repository_auth_structure(self, client):
        """Test that repository auths have all expected fields."""
        auths = client.gpu.image_registry.list_auths()
    ...
    def test_repository_auths_have_unique_ids(self, client):
...
class TestImageRegistryLifecycle:
    ...
    def test_create_delete_repository_auth(self, client):
        """
