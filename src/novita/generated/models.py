...
#   timestamp: 2025-10-26T14:58:15+00:00
...
class VolumeMount1(BaseModel):
    ...
    id: Annotated[
        str | None,
        Field(description="Cloud storage ID (present when type=network)."),
    ] = None
    mount_path: Annotated[
...
class Node(BaseModel):
    ...
    max_rootfs_size: Annotated[
        int | None,
        Field(alias="maxRootfsSize", description="Maximum root filesystem size."),
    ] = None
...
class InstanceInfo(BaseModel):
    ...
    product_id: Annotated[
        str,
        Field(alias="productId", description="Product ID used to deploy the instance."),
    ]
    product_name: Annotated[
        str,
        Field(alias="productName", description="Product name used to deploy the instance."),
    ]
    ...
    envs: Annotated[
        list[Env2] | None,
        Field(description="Instance environment variable information."),
    ] = None
    ...
    jobs: Annotated[
        list[Job] | None,
        Field(description="Tasks currently running on the instance."),
    ] = None
...
class CPUProduct(BaseModel):
    ...
    rootfs_size: Annotated[
        int | None,
        Field(alias="rootfsSize", description="Root filesystem capacity in GB"),
    ] = None
...
class State(BaseModel):
    ...
    state: Annotated[
        str | None,
        Field(description='Status value (e.g., "serving" when available)'),
    ] = None
...
class WorkerConfig(BaseModel):
    ...
    max_concurrent: Annotated[
        int | None,
        Field(alias="maxConcurrent", description="Request concurrency limit"),
    ] = None
    gpu_num: Annotated[
...
class EndpointDetail(BaseModel):
    ...
    volume_mounts: Annotated[
        list[VolumeMount2] | None,
        Field(alias="volumeMounts", description="Storage mounts"),
    ] = None
    ...
    cluster_id: Annotated[
        str | None,
        Field(alias="clusterID", description="Cluster location for cloud storage"),
    ] = None
...
class Endpoint(BaseModel):
    ...
    ports: Annotated[
        list[Port2],
        Field(description="HTTP port configuration (1-65535, excluding 2222-2224)"),
    ]
    ...
    rootfs_size: Annotated[
        int,
        Field(alias="rootfsSize", description="System disk size in GB (fixed at 100)"),
    ]
    volume_mounts: Annotated[
        list[VolumeMount3],
        Field(alias="volumeMounts", description="Storage configuration"),
    ]
    cluster_id: Annotated[
        str | None,
        Field(alias="clusterID", description="Required for cloud storage mounting"),
    ] = None
...
class JobModel(BaseModel):
    ...
    log_address: Annotated[
        str | None,
        Field(alias="logAddress", description="URL for accessing execution logs"),
    ] = None
    created_at: Annotated[
        str,
        Field(alias="createdAt", description="Job creation timestamp (Unix seconds)"),
    ]
    instance_id: Annotated[
...
class NetworkModel(BaseModel):
    ...
    addresses: Annotated[
        list[Address],
        Field(alias="Addresses", description="Instances within the VPC network"),
    ]
...
class CreateNetworkRequest(BaseModel):
    ...
    name: Annotated[
        str | None,
        Field(description="Custom VPC network name", max_length=30, min_length=0),
    ] = None
...
class UpdateNetworkRequest(BaseModel):
    ...
    name: Annotated[
        str | None,
        Field(description="Custom network name", max_length=30, min_length=1),
    ] = None
...
class NetworkStorageModel(BaseModel):
    ...
    storage_name: Annotated[
        str | None,
        Field(alias="storageName", description="User-defined storage name"),
    ] = None
    storage_size: Annotated[
        int | None,
        Field(alias="storageSize", description="Storage capacity measurement"),
    ] = None
    cluster_id: Annotated[
        str | None,
        Field(alias="clusterId", description="Associated cluster identifier"),
    ] = None
...
class CreateNetworkStorageRequest(BaseModel):
    ...
    storage_name: Annotated[
        str,
        Field(alias="storageName", description="Name assigned to the storage resource"),
    ]
    storage_size: Annotated[
...
class UpdateNetworkStorageRequest(BaseModel):
    ...
    storage_name: Annotated[
        str,
        Field(alias="storageName", description="The display name assigned to the storage"),
    ]
    storage_size: Annotated[
        str,
        Field(alias="storageSize", description="Capacity measurement in appropriate units"),
    ]
...
class TemplatePort(BaseModel):
    ...
    ports: Annotated[
        list[int],
        Field(description="Exposed ports (maximum of 10 per entry).", max_length=10),
    ]
...
class TemplateCreatePayload(BaseModel):
    ...
    channel: Annotated[Literal["private"], Field(description="Template channel.")]
    image: Annotated[str, Field(description="Docker image address for instance startup.")]
    start_command: Annotated[
        str,
        Field(alias="startCommand", description="Startup command for the instance."),
    ]
    rootfs_size: Annotated[
...
class ListNetworksResponse(BaseModel):
    network: Annotated[list[NetworkModel], Field(description="List of VPC networks")]
    total: Annotated[str, Field(description="Total count of VPC networks")]


class ListNetworkStoragesResponse(BaseModel):
    data: Annotated[
        list[NetworkStorageModel] | None,
        Field(description="Collection of storage records"),
    ] = None
...
class Template(BaseModel):
    ...
    create_time: Annotated[
        AwareDatetime | None,
        Field(alias="createTime", description="Template creation time."),
    ] = None
    user: Annotated[str | None, Field(description="ID of the user who created the template.")] = (
        None
    )
    tools: Annotated[list[str] | None, Field(description="Tools enabled for the template.")] = None
    name: Annotated[str, Field(description="Template name.")]
